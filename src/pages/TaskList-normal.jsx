...
import {ChakraProvider,Container,Text,VStack,Button,ButtonGroup,FormControl,FormLabel,
Input,FormHelperText,FormErrorMessage,Box,Divider,
Flex,useColorModeValue} from '@chakra-ui/react';
...
let contador =0;
  ...
  const sendTasksToServer = () => {
    ...
    console.log('Tareas enviadas al servidor:', data); /////consol para imprimir el modo en la Terminal
  };
  ...
  return (
      ...
      className="task-list-container">
        ...
        <Flex justifyContent="space-between" alignItems="center">
          <Text fontSize="3xl" color={textColor} fontWeight="bold">Activities list</Text>
            
        </Flex >
        
      
          <form onSubmit={handleSubmit(onSubmit) }>
            {/* Se usa para apolar verticalmen los BOx */}
              <FormControl isInvalid={isError} >
                <FormLabel color={labelColor} >Name of the homework:</FormLabel> 
                 <Input type='Task Name' placeholder="Enter your Task" 
                    _placeholder={{
                ...
                />
                 {showError && (
               <FormHelperText color="red.500">You must enter the task with at least 3 letters.</FormHelperText>
                )}
                {isError && <FormErrorMessage color="red.300">The task name is required.</FormErrorMessage>}
              </FormControl>
              <FormControl>
                ...
                {isError && <FormHelperText color={labelColor}>Enter the task description. (optional)</FormHelperText>}
            </FormControl>
